...
## Android项目目录介绍
![安卓项目结构](./androidStatic/androidActivity/androidProject.png)  
...
![布局与活动的关联](./androidStatic/androidActivity/activityShow.png)
...
在模拟器中点击按钮展示了Toast  
![展示效果](./androidStatic/androidActivity/showContent.png)  
...
![显示Intent跳转 ](./androidStatic/androidActivity/intentJump.gif) 
...
![隐式Intent跳转 ](./androidStatic/androidActivity/implictJump.gif) 
...
![传递数据](./androidStatic/androidActivity/deliverData.gif) 
...
![传递数据](./androidStatic/androidActivity/resultBack.gif) 
...
![singleTask模式](./androidStatic/androidActivity/singletask.png) 
