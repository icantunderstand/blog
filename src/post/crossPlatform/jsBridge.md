...
![拦截请求实现调用](./crossPlatformStatic/jsBridge/overrideUrlCall.png)
...
![重写Prompt方法调用](./crossPlatformStatic/jsBridge/overridePrompt.png)
...
![interface调用](./crossPlatformStatic/jsBridge/callInterface.png)
...
![evaluate调用js](./crossPlatformStatic/jsBridge/evaluateJS.png)
